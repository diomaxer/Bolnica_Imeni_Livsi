    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bezel_material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.bezelmaterial', verbose_name='Материал безеля')),
                ('bracer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.bracermaterial', verbose_name='Материал браслета')),
                ('bracer_colour', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.bracercolour', verbose_name='Цвет браслета')),
                ...
                ('corpus_material', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.material', verbose_name='Материал корпуса')),
                ('dial', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.colour', verbose_name='Циферблат')),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.equipment', verbose_name='Комплектация')),
                ('glass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.glass', verbose_name='Стекло')),
                ('meh_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.mehtype', verbose_name='Тип механизма')),
                ('numbers', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='prod.numbers', verbose_name='Цифры')),
