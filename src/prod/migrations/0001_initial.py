    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bezel_material', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.bezelmaterial', verbose_name='Материал безеля')),
                ('bracer', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.bracermaterial', verbose_name='Материал браслета')),
                ('bracer_colour', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.bracercolour', verbose_name='Цвет браслета')),
                ('brand', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.brand', verbose_name='Бренд')),
                ('condition', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.condition', verbose_name='Состояние часов')),
                ('corpus_material', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.material', verbose_name='Материал корпуса')),
                ('dial', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.colour', verbose_name='Циферблат')),
                ('equipment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.equipment', verbose_name='Комплектация')),
                ('glass', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.glass', verbose_name='Стекло')),
                ('meh_type', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.mehtype', verbose_name='Тип механизма')),
                ('numbers', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.numbers', verbose_name='Цифры')),
                ('sex', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='prod.sex', verbose_name='Пол')),
            ],
            options={
                'verbose_name': 'Часы',
